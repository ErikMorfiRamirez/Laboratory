<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <a class="navbar-brand " href="{{ route('home') }}">
            <img src="{{ asset('argon') }}/img/C.png" class="navbar-brand-img img-fluid" alt="...">
        </a>
        <!-- User -->
            ...
            <li class="nav-item dropdown">
                <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="media align-items-center">
                        ...
                        <img alt="Image placeholder" src="{{ asset('argon') }}/img/medico.jpg">
                        </span>
                    </div>
                </a>
               ...
               <!-- <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('pacientes') }}">
                        <i class="ni ni-favourite-28 text-red"></i> Pacientes
                    </a>
                </li>
                
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('medicos') }}">
                        <i class="ni ni-badge text-green"></i> Medicos
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('areas') }}">
                        <i class="ni ni-sound-wave text-black"></i> Áreas
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('finanzas') }}">
                        <i class="ni ni-chart-bar-32 text-warning"></i>Finanzas
                    </a>
                </li>
                <li class="nav-item">
